...
namespace TodoApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DatabaseContext>(item => item.UseSqlServer(DBConnection));

            services.AddScoped<IParemetrosRepository, ParemetrosRepository>();
            services.AddScoped<ISeguradosRepository, SeguradosRepository>();
